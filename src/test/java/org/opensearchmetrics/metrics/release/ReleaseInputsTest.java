...
public class ReleaseInputsTest {
    ...
    public void testGetState() {
        assertEquals("open", ReleaseInputs.VERSION_3_5_0.getState());
    ...
    public void testGetBranch() {
        assertEquals("main", ReleaseInputs.VERSION_3_5_0.getBranch());
    ...
    public void testGetAllReleaseInputs() {
        ...
        assertEquals(ReleaseInputs.VERSION_3_5_0, releaseInputs[0]);
        assertEquals(ReleaseInputs.VERSION_3_4_0, releaseInputs[1]);
