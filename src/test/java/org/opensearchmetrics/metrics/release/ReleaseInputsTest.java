...
public class ReleaseInputsTest {
    ...
    public void testGetAllReleaseInputs() {
        ...
        assertEquals(16, releaseInputs.length);
        ...
        assertEquals(ReleaseInputs.VERSION_1_3_15, releaseInputs[10]);
        assertEquals(ReleaseInputs.VERSION_1_3_16, releaseInputs[11]);
        assertEquals(ReleaseInputs.VERSION_1_3_17, releaseInputs[12]);
        assertEquals(ReleaseInputs.VERSION_1_3_18, releaseInputs[13]);
        assertEquals(ReleaseInputs.VERSION_1_3_19, releaseInputs[14]);
        assertEquals(ReleaseInputs.VERSION_1_3_20, releaseInputs[15]);
    }
