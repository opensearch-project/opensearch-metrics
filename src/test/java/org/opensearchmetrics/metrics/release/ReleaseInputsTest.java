...
public class ReleaseInputsTest {
    ...
    public void testGetState() {
        ...
        assertEquals("open", ReleaseInputs.VERSION_2_19_2.getState());
    ...
    public void testGetTrack() {
        ...
        assertEquals(true, ReleaseInputs.VERSION_2_19_2.getTrack());
    ...
    public void testGetAllReleaseInputs() {
        ...
        assertEquals(17, releaseInputs.length);
        ...
        assertEquals(ReleaseInputs.VERSION_2_19_1, releaseInputs[9]);
        assertEquals(ReleaseInputs.VERSION_2_19_2, releaseInputs[10]);
        assertEquals(ReleaseInputs.VERSION_1_3_15, releaseInputs[11]);
        assertEquals(ReleaseInputs.VERSION_1_3_16, releaseInputs[12]);
        assertEquals(ReleaseInputs.VERSION_1_3_17, releaseInputs[13]);
        assertEquals(ReleaseInputs.VERSION_1_3_18, releaseInputs[14]);
        assertEquals(ReleaseInputs.VERSION_1_3_19, releaseInputs[15]);
        assertEquals(ReleaseInputs.VERSION_1_3_20, releaseInputs[16]);
    }
