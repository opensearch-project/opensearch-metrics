...
export class OpenSearchMetricsNginxJenkins extends Stack {
    ...
    constructor(scope: Construct, id: string, props: NginxProps) {
        ...
        const instanceRole = this.createNginxReadonlyInstanceRole(props);
            ...
            this.asg = new AutoScalingGroup(this, 'OpenSearchMetricsJenkins-ProxyAsg', {
        ...
        Tags.of(this.asg).add("Name", "OpenSearchMetricsJenkins")
        ...
        if (props.nlbProps) {
            const lb = new NetworkLoadBalancer(this, `OpenSearchMetricsJenkins-NginxProxyNlb`, {
                loadBalancerName: "OpenSearchMetricsJenkins",
                vpc: vpc,
                internetFacing: true
            });
            ...
            const listener = lb.addListener(`OpenSearchMetricsJenkins-NginxProxyNlbListener`, {
                port: 443,
                protocol: Protocol.TLS,
                certificates: [listenerCertificate]
            });

            listener.addTargets(`OpenSearchMetricsJenkins-NginxProxyNlbTarget`, {
                port: 443,
                targets: [this.asg]
            });
        }
        ...
        const instanceName = `OpenSearchMetricsJenkins-NginxProxyHost`;
    ...
    private createNginxReadonlyInstanceRole(nginxProps: NginxProps): Role {
        const role = new Role(this, `OpenSearchMetricsJenkins-NginxProxyRole`, {
            assumedBy: new ServicePrincipal('ec2.amazonaws.com'),
            roleName: "OpenSearchMetricsJenkinsAccess",
        });
