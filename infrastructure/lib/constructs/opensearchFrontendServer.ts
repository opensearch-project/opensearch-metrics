...
export class OpenSearchHealthFrontendServer extends Stack {
    ...
    constructor(scope: Construct, id: string, props: ServerProps) {
        ...
        this.asg.addUserData(...this.getUserData(props.opensearchUrl, props.region, "opensearch_health"));
    }
    ...
    private getUserData(opensearchUrl: string, region: string, index: string): string[] {
        return [
            ...
            'DOMAIN_ENDPOINT=https://' + opensearchUrl + ' DOMAIN_REGION=' + region + ' HEALTH_INDEX=' + index + ' ENABLE_SIGV4=true' + ' docker-compose up -d'
        ];
    }
}